...
import { clusterFields } from '../config'
...
const setup = (props, context) => {
  ...
  const nameOptions = Object.values(clusterFields).sort((a, b) => a.value.localeCompare(b.value))
  ...
  const valueComponent = computed(() => {
    ...
    const { [name]: { types = [] } = {} } = clusterFields
